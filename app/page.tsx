        ...
        <section className="relative min-h-150 md:min-h-175 flex items-center pt-8 md:pt-12 pb-16 md:pb-20 overflow-hidden">
          <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="z-10 order-2 md:order-1 text-center md:text-right">
              ...
              <h1 className="text-4xl md:text-5xl font-black font-headline leading-tight text-primary mb-6">فائضك..<br/><span className="text-secondary">عونٌ لغيرك</span></h1>
              <p className="text-base md:text-lg text-on-surface-variant leading-relaxed mb-10 max-w-lg mx-auto md:mx-0">منصة مجتمعية قائمة على الثقة، تهدف لتسهيل عملية التبرع واستلام المواد الأساسية مجاناً وبكل كرامة.</p>
              
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <Link href="/add-item" className="px-10 py-4 rounded-full bg-linear-to-br from-primary to-primary-container text-white text-base md:text-lg font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-all">تبرع الآن</Link>
                <Link href="/browse" className="px-10 py-4 rounded-full bg-surface-container-highest text-[#005047] text-base md:text-lg font-bold hover:bg-[#d9dadb] transition-all">تصفح الاحتياجات</Link>
              </div>
            </div>
            ...
            <div className="relative order-1 md:order-2">
              ...
              <div className="relative rounded-[3rem] overflow-hidden shadow-2xl transform rotate-2 max-w-sm md:max-w-md mx-auto md:mx-0">
                <div className="relative w-full h-87.5 md:h-112.5">
                    <Image alt="عون" fill className="object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCw93s688quPK_GYTpPLVuSdOuokxVL_kAEivbgOMp05gcClG9rq12hyXUKaJ6o-vOhIVnNa2iO3Q926aEr96kORDXKkSSDf5d5v2b7l5TUI21FmHiZgUTvjTL9i9bnVEOLon-77Yp0iiQFKoHLR0XH7m-bHSzYURzpNqjGxPGeiYuHUY5r6gyOJxsFw3LUeO3EuWJ4cmgZMlxDEITYj1_ZXiFjdVC0kaqRx16gNtmg2xfy19b0aw1EEhC3M7NMoT3Ot0bQHMTgiXA" />
                </div>
        ...
        <section className="py-16 md:py-20 bg-surface-container-low">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-3xl md:text-4xl font-black font-headline text-primary mb-4">كيف تعمل منصة عون؟</h2>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="flex justify-between items-end mb-12">
              ...
              <Link className="flex items-center gap-2 text-primary font-bold group text-sm md:text-base" href="/browse">
                عرض الكل
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                {itemsFromDB.slice(0, 4).map((item) => (
                  <Link href={`/items/${item._id}`} key={item._id} className="group bg-white border border-surface-container-highest rounded-xl overflow-hidden hover:shadow-xl transition-all flex flex-col h-full">
                    <div className="relative h-48 md:h-52 overflow-hidden bg-gray-50">
<img 
  alt={item.title} 
  src={getImageUrl(item)} 
  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" 
/>                      <span className="absolute top-4 right-4 px-3 py-1 bg-primary/90 text-white text-xs font-bold rounded-full">{item.category || 'عام'}</span>
                    </div>
          ...
          <div className="container mx-auto px-6">
            <div className="bg-linear-to-br from-primary to-primary-container rounded-[2.5rem] md:rounded-[3rem] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl">
              ...
              <div className="flex flex-wrap justify-center gap-4 relative z-10">
                <Link href="/add-item" className="px-12 py-4 rounded-full bg-white text-primary text-lg font-bold shadow-xl hover:scale-105 transition-all text-center">
                  ابدأ التبرع الآن
                </Link>
              </div>
            </div>
