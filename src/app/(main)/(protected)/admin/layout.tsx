...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // ✅ الحل: لا نرندر شيء حتى نتأكد إننا على الكلايت
  ...
  // ✅ السيرفر والكلايت يتفقان على نفس الـ output (spinner)
  ...
  return (
    <div className="flex min-h-screen bg-[#f7f6f2]" dir="rtl">
      ...
      {/* Sidebar */}
      <aside className="w-56 bg-white border-l border-gray-100 shadow-sm fixed top-0 right-0 h-full pt-16 flex flex-col z-30">
      ...
      {/* Content */}
      <main className="flex-1 mr-56 pt-16 p-8 min-h-screen overflow-y-auto">
        {children}
      </main>
    </div>
  );
