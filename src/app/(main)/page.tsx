    ...
    >
      <main className="mt-16 md:mt-20">
        ...
        <section className="relative overflow-hidden pb-14 pt-8 md:pb-24 md:pt-14">
          ...
          <div className="absolute right-[-100px] top-16 -z-10 h-80 w-80 rounded-full bg-[#01696f]/8 blur-3xl" />
          <div className="absolute bottom-0 left-[-80px] -z-10 h-72 w-72 rounded-full bg-[#005a8c]/8 blur-3xl" />
            ...
            <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
              <div className="order-2 lg:order-1">
                <h1 className="max-w-2xl text-4xl font-black leading-[1.12] text-[#173335] md:text-[3.8rem]">
                  اجعل فائضك
                  <span className="block bg-gradient-to-l from-[#01696f] via-[#117b7f] to-[#005a8c] bg-clip-text text-transparent">
                    فرصة حياةٍ لغيرك
                  </span>
                </h1>
                ...
                <div className="mt-10 grid max-w-2xl grid-cols-1 gap-3 sm:grid-cols-3">
                  {[
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs font-bold leading-6 text-[#7a746d]">
                        {stat.label}
                      </p>
                    </div>
                  ))}
              ...
              <div className="order-1 lg:order-2">
                <div className="relative mx-auto max-w-[560px]">
                  <div className="absolute inset-0 rounded-[38px] bg-gradient-to-br from-[#01696f]/10 via-transparent to-[#005a8c]/10 blur-2xl" />
                  ...
                  <div className="relative overflow-hidden rounded-[36px] border border-white/70 bg-white/70 p-3 shadow-[0_28px_70px_rgba(15,23,42,0.12)] backdrop-blur-xl">
                    <div className="relative h-[360px] overflow-hidden rounded-[30px] md:h-[540px]">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0f1d1f]/35 via-transparent to-white/10" />
                    </div>
                    ...
                    <div className="absolute bottom-6 left-6 right-6 rounded-[26px] border border-white/25 bg-white/20 p-4 shadow-lg backdrop-blur-xl md:p-5">
                      <div className="flex items-start gap-3">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#01696f] to-[#005a8c] text-white shadow-md">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs leading-6 text-white/85 md:text-sm">
                            تجربة محسوبة لتشجيع العطاء، وتقليل التعقيد، وتعزيز الثقة بين أفراد المجتمع.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="absolute -left-4 top-10 hidden w-44 rounded-[24px] border border-[#e9e3da] bg-white p-4 shadow-[0_18px_42px_rgba(15,23,42,0.08)] md:block">
                    ...
                    <div className="mt-4 h-2 overflow-hidden rounded-full bg-[#edf1ef]">
                      <div className="h-full w-[82%] rounded-full bg-gradient-to-l from-[#01696f] to-[#35aaa7]" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                {[
                  {
                    icon: "verified_user",
                    title: "ثقة وشفافية",
                    desc: "بنية واضحة تعزز مصداقية التفاعل بين أفراد المجتمع",
                  },
                  {
                    icon: "bolt",
                    title: "استجابة أسرع",
                    desc: "الإشعارات الفورية تساعد على وصول المساعدة في الوقت المناسب",
                  },
                  {
                    icon: "groups",
                    title: "مجتمع متفاعل",
                    desc: "كل إضافة جديدة تفتح فرصة نفع حقيقي داخل المجتمع المحلي",
                  },
                  {
                    icon: "workspace_premium",
                    title: "تجربة احترافية",
                    desc: "واجهة سهلة ومريحة تشجع المستخدم على البدء دون تردد",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
        ...
        <section id="how-it-works" className="bg-white py-18 md:py-24">
          <div className="container mx-auto px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="relative overflow-hidden rounded-[34px] bg-gradient-to-bl from-[#01696f] via-[#117a7f] to-[#005a8c] p-8 text-white shadow-[0_26px_58px_rgba(1,105,111,0.20)] md:p-10">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-3">
                    {[
                      "واجهة مريحة وسلسة",
                      "تركيز بصري على الإجراء",
                      "إشارات ثقة واضحة",
                      "بطاقات أسهل للمسح السريع",
                    ].map((point, i) => (
                      <div
                        key={i}
                        className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm font-bold backdrop-blur-sm"
                      >
                        {point}
                      </div>
                    ))}
                ...
                {FEATURES.map((f, i) => (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[20px] bg-gradient-to-br from-[#e8f5f3] to-[#edf7fb] text-[#01696f] transition-transform duration-300 group-hover:scale-105">
                        <span className="material-symbols-outlined text-[28px]">{f.icon}</span>
                      </div>
                      {i !== FEATURES.length - 1 && (
                        <div className="mt-3 h-full w-px bg-gradient-to-b from-[#01696f]/20 to-transparent" />
                      )}
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="mb-2 flex items-center justify-between gap-3">
                        ...
                        <span className="text-xs font-black tracking-[0.2em] text-[#b4aca2]">
                          0{i + 1}
                        </span>
                      </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                {[
                  ...
                  >
                    <div className={`inline-flex rounded-2xl bg-gradient-to-l ${card.color} px-4 py-2 text-sm font-black text-white`}>
                      {card.num}
                    </div>
                  ...
                  >
                    ...
                    <div className="flex grow flex-col p-5">
                      <div className="mb-3 flex items-center gap-1.5 text-xs font-semibold text-[#7b746c]">
                        <span className="material-symbols-outlined text-[16px] text-[#01696f]">
                          location_on
                        </span>
            ...
            <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="rounded-[34px] border border-[#e8e2da] bg-white p-7 shadow-[0_14px_36px_rgba(15,23,42,0.05)] md:p-8">
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#01696f] to-[#005a8c] text-sm font-black text-white">
                    س
                  </div>
                  <div>
              ...
              <div className="grid gap-5">
                {[
                  {
                    title: "من البداية حتى الاستلام",
                    desc: "وضوح الخطوات يجعل المستخدم أكثر استعدادًا لإكمال العملية دون تردد.",
                    icon: "route",
                  },
                  {
                    title: "إشارات ثقة في الأماكن الصحيحة",
                    desc: "وجود مؤشرات الثقة قرب الأزرار يرفع الإحساس بالاحترافية والطمأنينة.",
                    icon: "shield",
                  },
                  {
                    title: "واجهة تشجع على العطاء",
                    desc: "كل قسم مصمم ليقود المستخدم بسهولة إلى الفعل الأساسي دون تشتيت.",
                    icon: "favorite",
                  },
                ].map((card, i) => (
                  <div
        ...
        <section className="bg-white py-18 md:py-24">
          <div className="container mx-auto px-6">
            ...
            <div className="mx-auto grid max-w-5xl gap-4">
              {[
                {
                  q: "كيف أبدأ بالتبرع عبر منصة عون؟",
                  a: "يمكنك إضافة العنصر أو الخدمة بسهولة من خلال زر “ابدأ التبرع الآن”، ثم تعبئة البيانات الأساسية وانتظار التفاعل من المستخدمين المهتمين.",
                },
                {
                  q: "هل استخدام المنصة مجاني؟",
                  a: "نعم، تجربة الاستخدام الأساسية على المنصة مجانية، والهدف منها تسهيل التكافل وتبادل النفع داخل المجتمع.",
                },
                {
                  q: "كيف يتم تعزيز الثقة بين المستخدمين؟",
                  a: "تعتمد المنصة على مؤشرات وثقة مجتمعية وتجربة واضحة تساعد على بناء الموثوقية وتحسين جودة التفاعل.",
                },
                {
                  q: "هل أستطيع تصفح الاحتياجات دون إضافة تبرع؟",
                  a: "نعم، يمكنك استعراض الإضافات والاحتياجات مباشرة عبر صفحة التصفح، ثم اتخاذ الإجراء المناسب حسب ما يناسبك.",
                },
              ].map((item, i) => (
                <details
                  key={i}
                ...
                >
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-right">
                    ...
                    <span className="material-symbols-outlined text-[#01696f] transition-transform duration-300 group-open:rotate-45">
                      add
                    </span>
                  </summary>
        ...
        <section className="pb-10 pt-18 md:pb-14 md:pt-24">
          <div className="container mx-auto px-6">
            <div className="relative overflow-hidden rounded-[38px] bg-gradient-to-bl from-[#0d5559] via-[#01696f] to-[#005a8c] px-6 py-12 shadow-[0_34px_80px_rgba(1,105,111,0.28)] md:px-12 md:py-16">
              <div className="absolute inset-0 opacity-10 [background-image:radial-gradient(circle_at_2px_2px,white_1px,transparent_0)] [background-size:30px_30px]" />
